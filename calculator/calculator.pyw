...
btn6=Button(root, text="n!",font="Times 10",width=4,height=1, command=factorial)
...
btn9=Button(root, text="sqrt",font="Times 10",width=4,height=1, command=sqrt)
btn9.grid(row=4,column=3,padx=2,pady=2)
btn10=Button(root, text="^",font="Times 10",width=4,height=1, command=lambda:number_button('**'))
